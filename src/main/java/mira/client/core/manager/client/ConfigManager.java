...
import mira.client.setting.impl.*;
...
public class ConfigManager implements IManager {
    public static final String CONFIG_FOLDER_NAME = "MiraClient";
    ...
    private void parseModule(JsonObject object, String category) throws NullPointerException {
        ...
        for (Setting setting : module.getSettings()) {
            try {
                ...
                LogUtils.getLogger().warn("[Mira] Module: " + module.getName() + " Setting: " + setting.getName() + " Error: ");
                e.printStackTrace();
            }
        }
    }
    ...
    public JsonObject getModuleObject(@NotNull Module m) {
        ...
        for (Setting setting : m.getSettings()) {
            if (setting.getValue() instanceof ColorSetting color) {
                ...
                attribs.add(setting.getName(), new JsonPrimitive(bool));
            } else if (setting.getValue() instanceof Float f) {
                attribs.add(setting.getName(), new JsonPrimitive(f));
            } else if (setting.getValue() instanceof Integer i) {
                attribs.add(setting.getName(), new JsonPrimitive(i));
