...
public class ModuleList extends HudElement {
    ...
    private final Setting<ColorSetting> color3 = new Setting<>("RectColor", new ColorSetting(0x82000000));
    private final Setting<ColorSetting> color4 = new Setting<>("SideRectColor", new ColorSetting(0xB4000000));
