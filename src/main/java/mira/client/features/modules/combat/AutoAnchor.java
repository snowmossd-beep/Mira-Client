...
public class AutoAnchor extends Module {
    ...
    private final Setting<Float> range = new Setting<>("Range", 4.3f, 1f, 4.5f);
    ...
    private void doCharge() {
        ...
        BlockHitResult chargeHit = computeInteractHit(anchorPos);
    ...
    private void doAttack() {
        ...
        BlockHitResult useHit = computeInteractHit(anchorPos);
    ...
    private BlockHitResult computeInteractHit(BlockPos pos) {
        InteractionUtility.BreakData data = InteractionUtility.getBreakData(pos, InteractionUtility.Interact.Strict);
        if (data != null && data.vector() != null && data.dir() != null) {
            return new BlockHitResult(data.vector(), data.dir(), pos, false);
        }
        return new BlockHitResult(pos.toCenterPos().add(0, 0.5, 0), Direction.UP, pos, false);
    }
