...
import mira.client.features.modules.combat.Criticals;
...
import static mira.client.features.modules.player.ElytraSwap.getChestPlateSlot;
...
public class ElytraPlus extends Module {
    ...
    private final mira.client.utility.Timer startTimer = new mira.client.utility.Timer();
    private final mira.client.utility.Timer redeployTimer = new mira.client.utility.Timer();
    private final mira.client.utility.Timer strictTimer = new mira.client.utility.Timer();
    private final mira.client.utility.Timer pingTimer = new mira.client.utility.Timer();
