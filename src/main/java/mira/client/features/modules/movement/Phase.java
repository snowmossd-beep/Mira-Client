...
import mira.client.events.impl.EventBreakBlock;
import mira.client.events.impl.EventCollision;
...
import static mira.client.features.modules.player.AutoTool.getTool;
