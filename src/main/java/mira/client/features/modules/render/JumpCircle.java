...
import static mira.client.utility.render.Render2DEngine.applyOpacity;
...
public class JumpCircle extends Module {
    ...
    public void onEnable() {
        try {
            custom = MiraUtility.getCustomImg("circle");
        } catch (Exception e) {
    ...
    public void onUpdate() {
        if (mode.is(Mode.Custom) && custom == null) {
            try {
                ...
                sendMessage(".minecraft -> MiraClient -> misc -> images -> circle.png");
            }
        }
