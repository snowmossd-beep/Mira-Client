package mira.client.utility.render.shaders;
...
import mira.client.utility.render.WindowResizeCallback;
import mira.client.utility.render.shaders.satin.api.managed.ManagedCoreShader;
import mira.client.utility.render.shaders.satin.api.managed.ShaderEffectManager;
import mira.client.utility.render.shaders.satin.api.managed.uniform.SamplerUniform;
...
public class BlurProgram {
    ...
    public static final ManagedCoreShader BLUR = ShaderEffectManager.getInstance()
            .manageCoreShader(Identifier.of("mira", "blur"), VertexFormats.POSITION);
